...
#import <CFDocumentScanSDK/CFDocumentScanSDK.h>
...
@class DynamicCaptureFeedbackOptions;
...
/// Configuration options for Dynamic Capture Feedback during Auto-Capture sessions. Only used if <code>captureMode</code> is set to <code>.Auto</code>.
@property (nonatomic, strong) DynamicCaptureFeedbackOptions * _Nonnull dynamicCaptureFeedbackOptions;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// The derived <code>MRZ_information</code> key used to authenticate via BAC / PACE with the eMRTD integrated chip, if supported
@property (nonatomic, readonly, copy) NSString * _Nullable mrzInformationKey;
/// Returns a string that represents the contents of the receiving class
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_CLASS("_TtC17CFDocumentScanSDK38DynamicCaptureFeedbackDetectionOptions")
@interface DynamicCaptureFeedbackDetectionOptions : NSObject
/// The detectors that are enforced while capturing the front of a license. Defaults to <code>.lightQuality</code>.
/// important:
/// <code>.barcode</code> and <code>.machineReadableZone</code> are ignored
@property (nonatomic) DynamicCaptureFeedbackEnforcedDetectors licenseFrontDetectors;
/// The detectors that are enforced while capturing the back of a license. Defaults to <code>.lightQuality</code>.
@property (nonatomic) DynamicCaptureFeedbackEnforcedDetectors licenseBackDetectors;
/// The detectors that are enforced while capturing the front of a passport card. Defaults to <code>.lightQuality</code>.
/// important:
/// <code>.barcode</code> and <code>.machineReadableZone</code> are ignored
@property (nonatomic) DynamicCaptureFeedbackEnforcedDetectors passportCardFrontDetectors;
/// The detectors that are enforced while capturing the back of a passport card. Defaults to <code>.machineReadableZone</code> and <code>.lightQuality</code>.
@property (nonatomic) DynamicCaptureFeedbackEnforcedDetectors passportCardBackDetectors;
/// The detectors that are enforced while capturing a passport biopage. Defaults to <code>.machineReadableZone</code> and <code>.lightQuality</code>.
/// important:
/// <code>.barcode</code> is ignored
@property (nonatomic) DynamicCaptureFeedbackEnforcedDetectors passportDetectors;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface DynamicCaptureFeedbackDetectionOptions (SWIFT_EXTENSION(CFDocumentScanSDK))
@property (nonatomic, readonly, copy) NSString * _Nonnull debugDescription;
@end


/// Configuration options for Dynamic Capture Feedback during Auto-Capture sessions
/// During Auto-Capture, corrective suggestions to improve capture quality can be interactively displayed to the end-user. This is called
/// “Dynamic Capture Feedback.” Enabling Dynamic Capture Feedback also unlocks additional detectors, resulting in higher-quality captures
/// and less round-trips from your application to the SDK.
/// important:
/// <code>DSOptions.captureType</code> must be set to <code>.Auto</code> in order for Dynamic Capture Feedback to be available.
SWIFT_CLASS("_TtC17CFDocumentScanSDK29DynamicCaptureFeedbackOptions")
@interface DynamicCaptureFeedbackOptions : NSObject
/// Toggles whether Dynamic Capture Feedback should be used during Auto-Capture. Defaults to <code>true</code>.
@property (nonatomic) BOOL isDynamicFeedbackEnabled;
/// Document-specific configuration options of enforced detectors during Dynamic Capture Feedback
@property (nonatomic, strong) DynamicCaptureFeedbackDetectionOptions * _Nonnull detectionOptions;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
